...
// 페이로드 두 종류, LEN으로 구분한다 (docs/design/protocol.md 2장, pi5/communication.py와 일치해야 함):
...
void communication_send_odometry(RobotPose pose, RobotVelocity velocity) {
    ...
    //   프레임 빠져도 되지만 제어 루프는 멈추면 안 된다 (docs/design/protocol.md 4장,
