...
> 현재 흐름은 [`architecture.md` 4장](../design/architecture.md#4-파이프라인-흐름과-구현-상태),
> 제어 루프는 [`algorithm.md` 5장](../design/algorithm.md#5-제어-루프-srcpi5mainpy-controlpy), 통신은
> [`docs/protocol.md`](../design/protocol.md) 를 본다.
